...
const Footer = (props: Props) => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center w-screen">
      ...
      <div className="bg-black w-screen mx-auto flex flex-col justify-center items-center">
        <footer className="bg-black text-white p-8 flex flex-col justify-center items-center w-full lg:p-[4rem] max-w-[90rem]">
