...
const HeroImage = (props: Props) => {
  return (
    <div className="relative flex flex-col justify-center md:items-center">
      <div className="absolute flex flex-col justify-between items-center text-center h-[23rem] p-[1.5rem] md:w-[23.6875rem] md:gap-[2rem] md:h-full md:p-0 md:justify-center">
        ...
        <p className="text-gray opacity-[.6] text-center font-[200] text-[1rem] tracking-[.1rem] leading-[1.5rem] md:font-[200]">
      ...
      <div className="">
        ...
        <Image
          alt="header image"
          src="/content/home/desktop/image-hero.jpg"
          priority={true}
          width={708.8}
          height={886}
          quality={100}
