            ...
            .map((product, index) => {
              return (
                ...
                >
                  ...
                  className="p-[1.5rem] mt-[4rem] md:h-[22rem] md:w-[43.0625rem] md:justify-center md:flex md:items-center lg:w-[33.75rem] lg:h-[35rem] ">
                    <Image
                      alt=""
                  ...
                  animate={{ opacity: "100%" }}
                  transition={{ duration: 0.9 }}
                  className="flex flex-col items-center justify-center gap-[1.5rem] text-center p-[1.5rem] leading-none lg:w-[27.8125rem] lg:text-start lg:items-start">
                    {index === 0 ? (
